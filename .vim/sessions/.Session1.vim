...
set shortmess=aoO
badd +35 Documents/pa06r-thesis/Thesis/Appendix_Biological_Neurons.tex
...
badd +1 Documents/neuro-sim/website/3.0/main/easel.js
...
badd +56 Documents/neuro-sim/website/3.0/index.html
...
badd +1 Documents/neuro-sim/website/3.0/database/create_database.php
...
silent! normal! zE
let s:l = 391 - ((29 * winheight(0) + 18) / 37)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 233 - ((7 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
233
...
normal! 06l
lcd ~/Documents/neuro-sim/website/3.0
tabedit ~/Documents/neuro-sim/website/3.0/database/create_database.php
TName "PHP"
lcd /home/peyman/Documents/neuro-sim/website/3.0
set splitbelow splitright
set nosplitbelow
...
set winheight=1 winwidth=1
argglobal
edit ~/Documents/neuro-sim/website/3.0/database/create_database.php
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 73 - ((23 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
